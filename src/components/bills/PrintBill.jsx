            ...
            <div className="bill-table-area mt-8">
              <table className="min-w-full divide-y divide-slate-500 overflow-hidden">
                <thead>
                  <tr className=" border-b border-slate-200">
                    <th
                      scope="col "
                      className="py-3.5 pt-4 text-left text-sm font-normal text-slate-700 sm:pl-6 md:pl-0 sm:table-cell hidden"
                    >
                      Görsel
                    </th>
                    <th
                    ...
                    <th
                      scope="col "
                      className="py-3.5 pt-4 text-center text-sm font-normal text-slate-700 sm:pl-6 md:pl-0 sm:table-cell hidden"
                    >
                      Fiyat
                    </th>
                    <th
                    ...
                    <th
                      scope="col "
                      className="py-3.5 pt-4 text-end text-sm font-normal text-slate-700 sm:pl-6 md:pl-0 sm:table-cell hidden"
                    >
                      Toplam
                    </th>
                  </tr>
                ...
                <tfoot>
                  <tr>
                    ...
                    <th className="text-right pt-6 " scope="row">
                      <span className="font-normal text-slate-500">57₺ </span>
                    </th>
                  </tr>
                  <tr>
                    <th className="text-right pt-4 " colSpan={"4"} scope="row">
                      <span className="font-normal text-slate-500">Tax</span>
                    </th>
                    <th className="text-right pt-4 " scope="row">
                      <span className="font-normal text-red-500">+4.88₺ </span>
                    </th>
                  </tr>
                  <tr>
                    <th className="text-right pt-4 " colSpan={"4"} scope="row">
                    ...
                    <th className="text-right pt-4 " scope="row">
                      <span className="font-normal text-slate-700">61.56₺</span>
                    </th>
                  </tr>
                </tfoot>
              </table>
              <div className="py-9 ">
                <div className="border-t pt-9 border-slate-200">
                  <p className="text-sm font-light border-slate-700">
