  ...
  return (
    <div className="border-b mb-6">
      <header className="py-4 px-6 flex justify-between items-center gap-10 ">
        ...
        <div className="menu-links flex justify-between items-center gap-6 md:static fixed bottom-0 md:w-auto w-screen md:bg-transparent bg-white lef-0 md:border-t-0 border-t md:px-0 px-4 py-1">
          <a
            href={"/"}
